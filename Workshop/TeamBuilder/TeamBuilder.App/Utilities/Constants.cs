namespace TeamBuilder.App.Utilities
{
    public class Constants
    {
        ...
        public static class ErrorMessages
        {
            ...
            // User error messages.
            public const string TeamNameNotValid = "TeamName {0} not valid!";
            public const string TeamAcronymNotValid = "Acronym {0} not valid!";
            public const string TeamDescriptionNotValid = "TeamDescription {0} not valid!";
            ...
            public const string StarDateAfterEndDate = "Start date should be before end date.";

            public const string InvalidDateFormat =
                                      "Please insert the dates in format: [dd/MM/yyyy HH:mm]!";
            public const string EventNameNotvalid = "Event name {0} is too long!";
            public const string EventDescriptionNotValid = "Event description {0} is too long!";
